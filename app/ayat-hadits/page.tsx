...
export default function AyatHaditsPage() {
  return (
      ...
      <Container>
        <div className="mx-auto max-w-xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-black tracking-tight text-[#032b22] md:text-5xl">
            Ayat & Hadits <span className="text-emerald-600">Pilihan</span>
          </h1>

          <p className="mt-6 text-base leading-relaxed text-slate-600">
            Halaman ini sedang dalam tahap pengembangan. Nantikan sajian inspirasi islami harian, kumpulan ayat Al-Qur'an, serta hadits pilihan yang menyejukkan hati dan menguatkan ukhuwah di sini.
          </p>
