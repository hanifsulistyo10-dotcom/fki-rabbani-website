      ...
      <Container>
        <div className="mx-auto max-w-xl text-center">
          ...
          <h1 className="mt-6 text-4xl font-black tracking-tight text-[#032b22] md:text-5xl">
            Agenda <span className="text-emerald-600">Rabbani</span>
          </h1>

          <p className="mt-6 text-base leading-relaxed text-slate-600">
            Halaman ini sedang dalam tahap pengembangan. Nantikan jadwal kajian rutin, event terdekat, serta berbagai agenda kegiatan menarik lainnya dari FKI Rabbani di sini.
          </p>
