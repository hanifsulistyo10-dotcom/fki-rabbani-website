...
export default function GalleryPage() {
  ...
  const categories = ['Semua', 'Kajian', 'Pengabdian', 'Kaderisasi', 'Acara Besar', 'Kebersamaan'];
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col">
      ...
      <main className="flex-1 pt-36 pb-20 px-6">
        {/* Diubah dari max-w-7xl ke max-w-6xl agar ukuran card keseluruhan lebih compact */}
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight">
              Galeri <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-700">FKI Rabbani</span>
            </h1>
            <p className="text-sm md:text-base text-slate-600 mt-4 leading-relaxed font-normal">
              Jejak langkah, kebersamaan, dan momen berharga dalam perjalanan dakwah keluarga&nbsp;besar&nbsp;FKI&nbsp;Rabbani&nbsp;Universitas&nbsp;Andalas.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {filteredGalleries.map((item) => (
                ...
                >
                  {/* Tinggi gambar sampul disesuaikan dari h-64 menjadi h-52 agar lebih ringkas */}
            ...
            <div className="text-center py-20 bg-white rounded-3xl border border-slate-200 shadow-sm max-w-xl mx-auto">
              <FolderOpen size={48} className="mx-auto text-emerald-500/60 mb-3 animate-bounce" />
              <p className="text-sm font-bold text-slate-700">Belum ada album galeri untuk kategori ini.</p>
              <p className="text-xs text-slate-400 mt-1">Silakan pilih kategori lainnya.</p>
            </div>
          )}
